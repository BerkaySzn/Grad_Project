...
def process_image(image, blur_kernel_size=(7, 7), canny_threshold1=30, canny_threshold2=100, 
                 dilation_kernel_size=(5, 5), dilation_iterations=2, edge_weight=0.3):
    ...
    enhanced_image = cv2.addWeighted(image, 1.0 - edge_weight, edge_mask, edge_weight, 0)
